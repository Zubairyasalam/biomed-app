...
@section('header_title', 'Registration Form Builder')
...
@section('content')
    ...
    <div style="display: grid; grid-template-columns: 1fr 350px; gap: 30px;">
        ...
        <div>
            <div class="card" style="margin-bottom: 30px;">
                ...
                <p style="color: #64748b; margin-bottom: 20px; font-size: 0.9rem;">This is exactly how your registration form looks to users. Hover over a field to edit or delete it.</p>
                        ...
                        @foreach($fields as $field)
                            <div class="form-group-preview" style="grid-column: {{ $field->grid_column === 'span 12' ? '1 / -1' : $field->grid_column }};">
                                ...
                                <div class="actions">
                                    ...
                                    <form action="{{ route('admin.form_fields.destroy', $field->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this field?');" style="margin: 0;">
                                        @csrf
                                        @method('DELETE')
        ...
        <div>
            <div class="card" style="position: sticky; top: 20px; max-height: calc(100vh - 40px); overflow-y: auto;">
                ...
                <form id="field-form" action="{{ route('admin.form_fields.store') }}" method="POST">
                    @csrf
    ...
    <script>
        ...
        function editField(field) {
            ...
            form.action = `/admin/form-fields/${field.id}`;
