...
@section('header_title', 'Guidelines Settings')

@section('content')
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        <h2 style="color: var(--admin-sidebar); font-size: 1.5rem;">Guidelines</h2>
        <p style="color: #64748b; font-size: 0.9rem;">Manage the content for the Abstract Submission Guidelines page.</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.guidelines.update') }}" enctype="multipart/form-data">
        @csrf
        <div style="display: grid; grid-template-columns: 1fr; gap: 30px;">
            
            @foreach(['guidelines' => 'Guidelines Content'] as $groupKey => $groupName)
