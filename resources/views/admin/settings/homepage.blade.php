...
@section('header_title', 'Homepage Sections')

@section('content')
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        <h2 style="color: var(--admin-sidebar); font-size: 1.5rem;">Homepage Content Modules</h2>
        <p style="color: #64748b; font-size: 0.9rem;">Manage the content for the Participants and Workshop sections on the homepage.</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.homepage_sections.update') }}">
        @csrf
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 30px;">
            
            @foreach(['participants' => 'Our Participants Section', 'workshop' => 'Pre-Conference Workshop Section', 'thrust_areas' => 'Thrust Areas (Conference Themes)'] as $groupKey => $groupName)
