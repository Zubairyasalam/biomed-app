...
@section('header_title', 'Global Site Settings')

@section('content')
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        <h2 style="color: var(--admin-sidebar); font-size: 1.5rem;">Global Configuration</h2>
        <p style="color: #64748b; font-size: 0.9rem;">Manage short text snippets used across the entire website.</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.settings.update') }}">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 30px;">
            ...
            @foreach(['hero' => 'Hero Banner Settings', 'contact' => 'Contact Information', 'about' => 'About Us Content'] as $groupKey => $groupName)
